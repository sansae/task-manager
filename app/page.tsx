...
export default function Home() {
  ...
  return (
    <div className="main flex flex-row">
      <div className="lg:w-1/2 flex min-h-screen flex-col md:flex-row items-center bg-zinc-100/90 px-4 py-6 font-sans text-zinc-950 transition-colors dark:bg-zinc-950 dark:text-zinc-50 sm:px-6">
          ...
          <TaskForm
            onTaskCreated={(task) => {
              try {
                ...
                showToast("Task has been added!", "error");
              }
            }}
            onTaskCreateError={() => showToast("Task has been added!", "error")}
          />
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <input
                  ...
                  autoComplete="off"
                  className="min-w-[12rem] flex-1 rounded-full border border-zinc-200 bg-white px-4 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 shadow-sm focus:border-zinc-400 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50 dark:placeholder:text-zinc-500 dark:focus:border-zinc-500 dark:focus:ring-zinc-700"
                />
                <button
                  type="button"
